  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <a href={locale === "pl" ? "/" : "/en"} className={styles.logo}>
          TOKAMA
        </a>

        <nav className={styles.lang} aria-label="Language switcher">
          <a href="/rezerwacja" className={locale === "pl" ? styles.active : ""}>
            PL
          </a>
          <span>/</span>
          <a href="/en/book" className={locale === "en" ? styles.active : ""}>
            EN
          </a>
        </nav>
      </header>
